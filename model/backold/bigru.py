...
# @Last Modified time: 2018-03-01 17:09:31
import torch
...
class BiGRU(nn.Module):
    def __init__(self, data):
        ...
        self.lstm = nn.GRU(self.embedding_dim + self.char_hidden_dim, lstm_hidden, num_layers=self.lstm_layer, batch_first=True, bidirectional=self.bilstm_flag)
